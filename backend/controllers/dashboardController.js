...
const dashboardController = {
  // Tableau de bord du leader - VERSION SIMPLIFIÉE TEMPORAIRE
  getLeaderDashboard: async (req, res) => {
    try {
      console.log('Dashboard request received for user:', req.user?.role);
      const userRole = req.user?.role || 'unknown';

      // Version simplifiée sans requêtes DB pour éviter les erreurs
